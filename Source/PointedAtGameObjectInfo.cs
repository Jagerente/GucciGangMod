...
public class PointedAtGameObjectInfo : MonoBehaviour
{
    private void OnGUI()
    {
        if (InputToEvent.goPointedAt != null)
        {
            ...
            if (photonView != null)
            {
                object[] args = {photonView.viewID, photonView.instantiationId, photonView.prefix, !photonView.isSceneView ? !photonView.isMine ? "owner: " + photonView.ownerId : "mine" : "scene"};
