...
public class FengGameManagerMKII : MonoBehaviour
{
    ...
    public void OnGUI()
    {
        ...
        if (!isAssetLoaded) GGM.GUI.Pages.LoadingScreen();


        switch (GGM.GUI.Pages.Page)
        {
            case "Main Menu" when isAssetLoaded:
                {
            ...
            case "Single":
                {
                    GGM.GUI.Pages.Single();
                }
                break;

            case "Multiplayer":
                {
                    GGM.GUI.Pages.Multiplayer();
                }
                break;
                    ...
                    if (flag2 && selectedObj != null)
                    {
                        ...
                        else if (selectedObj.name.StartsWith("misc"))
                        {
                                ...
                                selectedObj.name.Contains("racing"))
                            {
                                ...
                                name = selectedObj.name;
                                selectedObj.name = name + "," + (string)settings[70] + "," + (string)settings[71] +
                                                   "," + (string)settings[72];
                            }
                        }
            ...
            case "Menu":
                {
                    ...
                    if ((int)settings[64] != 6)
                    {
                        ...
                        {
                            GGM.GUI.Pages.Page = string.Empty;
                            if (IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE)
                            {
                                Time.timeScale = 1f;
                            }
                            ...
                            if (!Camera.main.GetComponent<IN_GAME_MAIN_CAMERA>().enabled)
                            {
                                Screen.showCursor = true;
                                Screen.lockCursor = true;
                                GameObjectCache.Find("InputManagerController").GetComponent<FengCustomInputs>().menuOn =
                                    false;
                                Camera.main.GetComponent<SpectatorMovement>().disable = false;
                                Camera.main.GetComponent<MouseLook>().disable = false;
                            }
                            else
                            {
                                ...
                                GameObjectCache.Find("InputManagerController").GetComponent<FengCustomInputs>().menuOn =
                                    false;
                                GameObjectCache.Find("InputManagerController").GetComponent<FengCustomInputs>()
                                    .justUPDATEME();
                            }
                        }
